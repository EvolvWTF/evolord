@echo off
REM Generate self-signed TLS certificates for Evolord (Windows)
...
echo =========================================
echo Generating TLS Certificates for Evolord
echo =========================================
...
echo   1. Set environment variable: set EVOLORD_TLS=true
echo   2. Optionally set custom paths:
echo      set EVOLORD_TLS_CERT=%CERT_DIR%\server.crt
echo      set EVOLORD_TLS_KEY=%CERT_DIR%\server.key
echo.

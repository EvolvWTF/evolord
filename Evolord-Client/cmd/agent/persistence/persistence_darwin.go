...
<dict>
	<key>Label</key>
	<string>com.evolord.agent</string>
	...
	<string>/tmp/evolord-agent.log</string>
	<key>StandardErrorPath</key>
	<string>/tmp/evolord-agent-error.log</string>
</dict>
</plist>
`
...
func getPlistPath() (string, error) {
	...
	return filepath.Join(usr.HomeDir, "Library", "LaunchAgents", "com.evolord.agent.plist"), nil
}
...
func getTargetPath() (string, error) {
	...
	return filepath.Join(usr.HomeDir, "Library", "Application Support", "Evolord", "agent"), nil
}

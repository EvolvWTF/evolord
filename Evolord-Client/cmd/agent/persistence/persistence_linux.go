...
func getSystemdPath() (string, error) {
	...
	return filepath.Join(usr.HomeDir, ".config", "systemd", "user", "evolord-agent.service"), nil
}
...
func getAutostartPath() (string, error) {
	...
	return filepath.Join(usr.HomeDir, ".config", "autostart", "evolord-agent.desktop"), nil
}
...
func getTargetPath() (string, error) {
	...
	return filepath.Join(usr.HomeDir, ".local", "share", "evolord", "agent"), nil
}

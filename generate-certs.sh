#!/bin/bash
# Generate self-signed TLS certificates for Evolord
...
echo "  1. Set environment variable: EVOLORD_TLS=true"
echo "  2. Optionally set custom paths:"
echo "     EVOLORD_TLS_CERT=$CERT_DIR/server.crt"
echo "     EVOLORD_TLS_KEY=$CERT_DIR/server.key"
echo ""
